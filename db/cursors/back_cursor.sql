...
/* - [[NO] SCROLL] – указание того, что курсор можно прокручивать или нет назад.
Если указано NO SCROLL, то прокрутка назад невозможна.
Если ничего не указано, то возможность прокрутки зависит от запроса. */
BEGIN;
DECLARE
